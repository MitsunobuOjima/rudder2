    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content" style="height: 700px;">
                <div class="container" style="margin-top: 100px;background-color: #CC5571;">
                    <form id="disp_sales_data" method="POST" action="">
                        ...
                        {{--
                            key is {{$key}}<br />
                            val['id'] is {{$val->id}}<br />
                            val['name'] is {{$val->name}}<br />
                            val['code'] is {{$val->code}}<br />
                            val['team'] is {{$val->team}}<br />
                            val['sort'] is {{$val->sort}}<br />
                            val['coefficient'] is {{$val->coefficient}}<br />
                            val['del_flg'] is {{$val->del_flg}}<br />
                            val['create_date'] is {{$val->create_date}}<br />
                            val['update_date'] is {{$val->update_date}}<br />
                        --}}

                            <div class="col-sm-1" style="background-color:#e6e6fa;width:20%;float:left;text-align:left;">
                            {{Form::checkbox('selectedBrands[]', $val->id, false, ['class'=>'custom-control-input','id'=>'selectedBrands'])}} {{$val->name}}
                            </div>
                        @endforeach
                        </div>

                        <div style="background-color: #481634; margin: 30px;">
                        期間
                        <select class="form-control widthselect" name="fromyear">
                        <option value="">---</option>
                        ...
                        <select class="form-control widthselect" name="frommonth">
                        <option value="">---</option>
                        ...
                        <select class="form-control widthselect" name="toyear">
                        <option value="">---</option>
                        <option value="2015">2015</option>
                        <option value="2016">2016</option>
                        <option value="2017">2017</option>
                        ...
                        <label class="float-left textlabel">&nbsp;年</label>
                        <select class="form-control widthselect" name="tomonth">
                        <option value="">---</option>
                        <option value="1">1</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
